        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full_name" placeholder="E.g. Sylvana Adusei" class="input-responsive" required>
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO order SET 
            ...
            if($res==true){
                ...
                $_SESSION['add'] = "<div class='success text-center'>Thank you for ordering from us.</div>";
                header("location:".SITEURL);
            }
            else{
                //Failed. Redirect to order page
                $_SESSION['add'] = "<div class='error text-center'>Sorry, your order was unsuccessful.</div>";
